...
static void ReadData(SQLiteConnection myConnection)
{
    ...
    //customer.firstName, customer.lastname, status.statustype " +
    //"FROM customerStatus " +
...
static void InsertCustomer(SQLiteConnection myConnection)
{
    ...
    Console.WriteLine("Enster last name:");
    lName = Console.ReadLine();
    Console.WriteLine("Enter date of birh (mm-dd-yyyy):");
...
static void FindCustomer(SQLiteConnection myConnection)
{
    ...
    string searchName;
    Console.WriteLine(("Enter a first name to dispaly customer data:"));
